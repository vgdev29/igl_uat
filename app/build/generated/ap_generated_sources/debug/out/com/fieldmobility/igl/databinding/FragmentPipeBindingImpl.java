...
public class FragmentPipeBindingImpl extends FragmentPipeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.pdf_button, 11);
        sViewsWithIds.put(R.id.txt_pdf, 12);
        sViewsWithIds.put(R.id.et_location, 13);
    ...
    public FragmentPipeBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private FragmentPipeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
