...
public class Ng_Pending_Fragment extends Activity implements NgUserDone_DeclineListAdapter.UpdateList{
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                try {
                    //bp_no_array.clear();
                    //Feasivility_List();
                    if(Utils.isNetworkConnected(Ng_Pending_Fragment.this)){
                        loadNgUserList();
                    }else {
                        Utils.showToast(Ng_Pending_Fragment.this,"Please check your connectivity");
                    }
    ...
    private void loadNgUserList() {
        ...
        Call<ArrayList<NguserListModel>> call = api.getNgListForApproval("OP","DP","1");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (claimUserList.size()>0) {
                    ...
                    adapter = new NgUserDone_DeclineListAdapter(Ng_Pending_Fragment.this, claimUserList);
