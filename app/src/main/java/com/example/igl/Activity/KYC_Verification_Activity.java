...
public class KYC_Verification_Activity extends AppCompatActivity implements KYC_Adapter.ContactsAdapterListener{
    ...
    private void Layout_ID() {
        ...
        /*recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent=new Intent(KYC_Verification_Activity.this,Kyc_Foram_Activity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.BP_No_Get_Listing+"/"+sharedPrefs.getUUID(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new KYC_Adapter(KYC_Verification_Activity.this,bp_no_array, KYC_Verification_Activity.this);
