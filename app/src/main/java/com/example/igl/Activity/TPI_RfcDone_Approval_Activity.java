...
public class TPI_RfcDone_Approval_Activity extends Activity {
  ...
  //  MaterialDialog materialDialog;
    ...
    TextView header_title,bpno,custname,mob,email,adress,metermake,meterno,metertype,initialreading,clamming;
    ...
    public void inflateData()
    {
        ...
        metermake.setText(bp_no_item.getLpg_distributor());
        meterno.setText(bp_no_item.getUnique_lpg_Id());
        metertype.setText(bp_no_item.getLpg_conNo());
    ...
    public void tpi_approval_done() {
        ...
        materialDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.TPI_RFC_APPROVAl_DECLINE,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        materialDialog.dismiss();
            ...
            protected Map<String, String> getParams() {
                ...
                try {
                    ...
                    params.put("status", "0");
                    params.put("meterNo", bp_no_item.getUnique_lpg_Id());
