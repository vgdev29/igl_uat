...
import com.example.igl.Helper.BuildConfig;
import com.example.igl.Helper.LocationMonitoringService;
import com.example.igl.MataData.MyService;
...
public class Tracking_Activity extends AppCompatActivity {
    ...
    public void StartBackgroundTask() {
        ...
        String latitude = MyService.Latitude;
        String longitude = MyService.Longitude;
        Log.e("latitude_longitude  ",latitude+"++++++"+longitude);
    }
    ...
    private void promptInternetConnect() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Tracking_Activity.this);
            ...
            showSnackbar(R.string.permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(Tracking_Activity.this,
