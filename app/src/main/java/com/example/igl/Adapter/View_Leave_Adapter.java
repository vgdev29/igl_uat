...
public class View_Leave_Adapter extends RecyclerView.Adapter<View_Leave_Adapter.ViewHolder> implements Filterable {
    Context context;
    // RecyclerView recyclerView;
    private List<View_Leave_Item> bp_no_list_array;
    private List<View_Leave_Item> New_bp_no_list_array;
    private View_Leave_Adapter.ContactsAdapterListener listener;
    public View_Leave_Adapter(Context context, List<View_Leave_Item> New_bp_no_list_array, View_Leave_Adapter.ContactsAdapterListener listener) {
    ...
    @Override
    public View_Leave_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.view_leave_item, parent, false);
        View_Leave_Adapter.ViewHolder viewHolder = new View_Leave_Adapter.ViewHolder(listItem);
    ...
    @Override
    public void onBindViewHolder(View_Leave_Adapter.ViewHolder holder, int position) {
        ...
        holder.to_date_text.setText(Bp_No_array.getLeave_to_date());
        holder.from_time_text.setText(Bp_No_array.getStart_time());
        holder.to_time_text.setText(Bp_No_array.getEnd_time());
        holder.descreption_text.setText("Descreption: "+Bp_No_array.getDescription());
        holder.status_text.setText(Bp_No_array.getStatus());
    }
    @Override
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (View_Leave_Item row : New_bp_no_list_array) {
                        if (row.getLeave_from_date().toLowerCase().contains(charString.toLowerCase()) || row.getStatus().toLowerCase().contains(charString.toLowerCase())) {
