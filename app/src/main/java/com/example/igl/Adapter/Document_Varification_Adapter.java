...
import com.example.igl.Activity.Document_varification_Detail;
...
public class Document_Varification_Adapter extends RecyclerView.Adapter<Document_Varification_Adapter.ViewHolder> implements Filterable {
    Context context;
    // RecyclerView recyclerView;
    private List<Bp_No_Item> bp_no_list_array;
    private List<Bp_No_Item> New_bp_no_list_array;
    private Document_Varification_Adapter.ContactsAdapterListener listener;
    public Document_Varification_Adapter(Context context, List<Bp_No_Item> New_bp_no_list_array, Document_Varification_Adapter.ContactsAdapterListener listener) {
    ...
    @Override
    public Document_Varification_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.bp_no_listing_item, parent, false);
        Document_Varification_Adapter.ViewHolder viewHolder = new Document_Varification_Adapter.ViewHolder(listItem);
    ...
    @Override
    public void onBindViewHolder(Document_Varification_Adapter.ViewHolder holder, final int position) {
        ...
        holder.liner_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, Document_varification_Detail.class);
