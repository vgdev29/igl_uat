...
import com.example.igl.Activity.KYC_Listing;
import com.example.igl.Activity.Kyc_Foram_Activity;
...
public class KYC_Adapter  extends RecyclerView.Adapter<KYC_Adapter.ViewHolder> implements Filterable {
    ...
    private KYC_Adapter.ContactsAdapterListener listener;
    public KYC_Adapter(Context context, List<Bp_No_Item> New_bp_no_list_array, KYC_Adapter.ContactsAdapterListener listener) {
    ...
    public void onBindViewHolder(KYC_Adapter.ViewHolder holder, final int position) {
        ...
        if(Bp_No_array.getIgl_status().equals("2")){
            ...
            if(Bp_No_array.getIgl_status().equals("3")){
                holder.status_text.setVisibility(View.VISIBLE);
                holder.status_text.setText("Verification KYC Pending");
            }
        }
      holder.liner_layout.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              Intent intent=new Intent(context, Kyc_Foram_Activity.class);
