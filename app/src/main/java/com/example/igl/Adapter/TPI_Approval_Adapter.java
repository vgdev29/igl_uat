...
public class TPI_Approval_Adapter extends RecyclerView.Adapter<TPI_Approval_Adapter.ViewHolder> implements Filterable {
    Context context;
    // RecyclerView recyclerView;
    private List<Bp_No_Item> bp_no_list_array;
    private List<Bp_No_Item> New_bp_no_list_array;
    private TPI_Approval_Adapter.ContactsAdapterListener listener;
    MaterialDialog materialDialog;
    SharedPrefs sharedPrefs;
    String Claim_Flage,JobFlage,BP_N0;
    public TPI_Approval_Adapter(Context context, List<Bp_No_Item> New_bp_no_list_array, TPI_Approval_Adapter.ContactsAdapterListener listener) {
    ...
    @Override
    public TPI_Approval_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.tpi_approval_adapter, parent, false);
        sharedPrefs=new SharedPrefs(context);
        TPI_Approval_Adapter.ViewHolder viewHolder = new TPI_Approval_Adapter.ViewHolder(listItem);
        RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        listItem.setLayoutParams(lp);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(TPI_Approval_Adapter.ViewHolder holder, final int position) {
        ...
        holder.liner_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(IGL_Status.equals("2")){
                    ...
                    Log.d("debug","TPI Approval Adapter");
