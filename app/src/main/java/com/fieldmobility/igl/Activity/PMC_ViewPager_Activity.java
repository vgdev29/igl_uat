...
import com.fieldmobility.igl.Fragment.PMC_RFC_approval_Fragment;
import com.fieldmobility.igl.Fragment.PMC_RFC_pending_Fragment;
...
public class PMC_ViewPager_Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new PMC_RFC_pending_Fragment(PMC_ViewPager_Activity.this),"RFC Pending");
        adapter.addFragment(new PMC_RFC_approval_Fragment(PMC_ViewPager_Activity.this),"RFC Approval");
