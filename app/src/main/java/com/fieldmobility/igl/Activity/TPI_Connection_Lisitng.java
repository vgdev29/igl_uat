...
public class TPI_Connection_Lisitng extends Activity implements RFC_Approval_Adapter.ContactsAdapterListener{
    ...
    private void Layout_ID() {
        ...
        header_title.setText("TPI Listing");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent=new Intent(TPI_Connection_Lisitng.this,TPI_Connection_Activity.class);
    ...
    public void Bp_No_List() {
        materialDialog = new MaterialDialog.Builder(this)
                ...
                .progress(true, 0)
                .show();
        String url = Constants.TPI_RFC_PENDING;
        Log.d(log,"bp no list url = "+url);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new RFC_Approval_Adapter(TPI_Connection_Lisitng.this,bp_no_array,TPI_Connection_Lisitng.this);
