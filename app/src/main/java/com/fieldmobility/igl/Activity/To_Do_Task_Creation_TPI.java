...
public class To_Do_Task_Creation_TPI extends Activity {
    ...
    private void Click_Event() {
        ...
        time_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // time picker dialog
                pickerDialog_Time = new TimePickerDialog(To_Do_Task_Creation_TPI.this,
        ...
        date_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pickerDialog_Date = new DatePickerDialog(To_Do_Task_Creation_TPI.this,
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, Constants.Get_TODOCATEGORY, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try{
                    ...
                    spinner_todo_catagory.setAdapter(new ArrayAdapter<String>(To_Do_Task_Creation_TPI.this, android.R.layout.simple_spinner_dropdown_item, TODO_CATAGORY_ARRAY));
    ...
    public void To_DO_List() {
        ...
        StringRequest jr = new StringRequest(Request.Method.POST, Constants.RFCtodo,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(To_Do_Task_Creation_TPI.this, "" + "Successfully", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                try {
                    Log.e("mobileNo", getIntent().getStringExtra("mobileNo"));
                    Log.e("Full_Name", getIntent().getStringExtra("Full_Name"));
                    params.put("id", sharedPrefs.getUUID());
                    params.put("bpno",getIntent().getStringExtra("Bp_number"));
                    ...
                    params.put("name", getIntent().getStringExtra("Full_Name"));
