...
import com.fieldmobility.igl.Adapter.Decline_Adapter;
...
public class RFC_Declined_Listing extends Activity implements Decline_Adapter.ContactsAdapterListener{
    ...
    public void Bp_No_List() {
        materialDialog = new MaterialDialog.Builder(this)
                ...
                .progress(true, 0)
                .show();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.RFC_LISTING_GET+sharedPrefs.getUUID(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new Decline_Adapter(RFC_Declined_Listing.this,bp_no_array,RFC_Declined_Listing.this);
