...
public class PoolTask_Activity extends Activity implements RFC_Approval_Adapter.ContactsAdapterListener{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.RFC_LISTING_TPI_GET+sharedPrefs.getZone_Code(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new RFC_Approval_Adapter(PoolTask_Activity.this,bp_no_array,PoolTask_Activity.this);
    ...
    public void onContactSelected(Bp_No_Item contact) {
        Toast.makeText(PoolTask_Activity.this, "Selected: " + contact.getBp_number() + ", " + contact.getFirst_name(), Toast.LENGTH_LONG).show();
