...
public class KYC_Pending_Activity extends AppCompatActivity {
    ...
    public void Bp_No_List() {
        Log.d(log,"url pending = "+Constants.BP_No_Get_Listing+"/"+sharedPrefs.getUUID());
        bp_no_array.clear();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0; i<payload.length();i++) {
                                ...
                                JSONObject data_object = payload.getJSONObject(i);
                                if (data_object.getString("igl_status").equalsIgnoreCase("2"))
                                {
                                Bp_No_Item bp_no_item = new Bp_No_Item();
                       ...
                       // DesignerToast.Custom(KYC_Listing.this,"Successfully",Gravity.BOTTOM,Toast.LENGTH_SHORT, R.drawable.shape_cornor_radious,15,"#FFFFFF",R.drawable.ic_success, 60, 200);
                         adapter = new KYC_Adapter(KYC_Pending_Activity.this,bp_no_array);
