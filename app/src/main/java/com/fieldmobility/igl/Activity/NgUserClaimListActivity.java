...
import com.fieldmobility.igl.NgUserListViewModel;
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (claimUserList.size()>0) {
                    ...
                    adapter = new TPI_NgPending_Adapter(NgUserClaimListActivity.this, claimUserList,NgUserClaimListActivity.this);
