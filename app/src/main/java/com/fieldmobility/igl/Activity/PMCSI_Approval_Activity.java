...
import com.fieldmobility.igl.Adapter.RFC_Approval_Adapter;
...
public class PMCSI_Approval_Activity extends Activity implements RFC_Approval_Adapter.ContactsAdapterListener{
    ...
    public PMCSI_Approval_Activity() {
       ...
       /* recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if(IGL_Status.equals("2")){
                    Toast.makeText(Ready_Inspection_Tpi_Fragment.this, "" + "Only Open TPI Approval Pending", Toast.LENGTH_SHORT).show();

                }else {
                    Intent intent=new Intent(Ready_Inspection_Tpi_Fragment.this, TPI_Inspection_RFC_Activity.class);
    ...
    public void Bp_No_List() {
        ...
        materialDialog = new MaterialDialog.Builder(this)
                ...
                .progress(true, 0)
                .show();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.RFC_LISTING_TPI_GET+sharedPrefs.getZone_Code(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new RFC_Approval_Adapter(PMCSI_Approval_Activity.this,bp_no_array,PMCSI_Approval_Activity.this);
    ...
    public void onContactSelected(Bp_No_Item contact) {
        Toast.makeText(PMCSI_Approval_Activity.this, "Selected: " + contact.getBp_number() + ", " + contact.getFirst_name(), Toast.LENGTH_LONG).show();
