        ...
        holder.liner_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bp_no_list_array.get(position).getIgl_status().equalsIgnoreCase("2")) {
                    Intent intent=null;
                    if (bp_no_list_array.get(position).getId_image() != null && !bp_no_list_array.get(position).getId_image().isEmpty() && !bp_no_list_array.get(position).getId_image().equals("null")) {
                        intent =new Intent(context, KycResubmissionActivity.class);
                    }
                    else {
                        intent =new Intent(context, Kyc_Form_Activity.class);
