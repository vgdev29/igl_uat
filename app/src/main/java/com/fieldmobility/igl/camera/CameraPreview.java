package com.fieldmobility.igl.camera;
...
public class CameraPreview extends ViewGroup {
    ...
    private static final String TAG = com.journeyapps.barcodescanner.CameraPreview.class.getSimpleName();
    ...
    private final Handler.Callback stateCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == com.google.zxing.client.android.R.id.zxing_prewiew_size_ready) {
                // At this point, we have the camera preview size, and should have containerSize and
                // surfaceRect.
                previewSized((Size) message.obj);
                return true;
            } else if (message.what == com.google.zxing.client.android.R.id.zxing_camera_error) {
            ...
            } else if (message.what == com.google.zxing.client.android.R.id.zxing_camera_closed) {
    ...
    protected void initializeAttributes(AttributeSet attrs) {
        TypedArray styledAttributes = getContext().obtainStyledAttributes(attrs, com.google.zxing.client.android.R.styleable.zxing_camera_preview);

        int framingRectWidth = (int) styledAttributes.getDimension(com.google.zxing.client.android.R.styleable.zxing_camera_preview_zxing_framing_rect_width, -1);
        int framingRectHeight = (int) styledAttributes.getDimension(com.google.zxing.client.android.R.styleable.zxing_camera_preview_zxing_framing_rect_height, -1);

        if (framingRectWidth > 0 && framingRectHeight > 0) {
            this.framingRectSize = new Size(framingRectWidth, framingRectHeight);
        }

        this.useTextureView = styledAttributes.getBoolean(com.google.zxing.client.android.R.styleable.zxing_camera_preview_zxing_use_texture_view, true);

        // See zxing_attrs.xml for the enum values
        int scalingStrategyNumber = styledAttributes.getInteger(com.google.zxing.client.android.R.styleable.zxing_camera_preview_zxing_preview_scaling_strategy, -1);
    ...
    public void pause() {
        ...
        if (cameraInstance != null) {
            ...
            stateHandler.sendEmptyMessage(com.google.zxing.client.android.R.id.zxing_camera_closed);
        }
