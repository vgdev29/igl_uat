...
public class MdpeTPIDPR_Adapter extends RecyclerView.Adapter<MdpeTPIDPR_Adapter.ViewHolder> implements Filterable {
    Context context;
    ...
    public MdpeTPIDPR_Adapter(Context context, List<DprDetails_Model> mdpelist) {
    ...
    @Override
    public MdpeTPIDPR_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.mdpetpidpr_adapter, parent, false);
        sharedPrefs=new SharedPrefs(context);
        MdpeTPIDPR_Adapter.ViewHolder viewHolder = new MdpeTPIDPR_Adapter.ViewHolder(listItem);
    ...
    @Override
    public void onBindViewHolder(MdpeTPIDPR_Adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
