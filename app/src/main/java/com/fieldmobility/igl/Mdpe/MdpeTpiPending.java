...
import com.fieldmobility.igl.databinding.ActivityMdpeTpiPendingBinding;
...
public class MdpeTpiPending extends AppCompatActivity {
    SharedPrefs sharedPrefs;
    RecyclerView recyclerView;
    SwipeRefreshLayout mSwipeRefreshLayout;
    MdpeTPI_Adapter mdpeList_adapter;
    EditText editTextSearch;
    TextView text_count;
    ProgressDialog progressDialog;
    static String log = "mdpetpipending";
    ...
    Button refresh ;
    ActivityMdpeTpiPendingBinding tpiPendingBinding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       tpiPendingBinding = DataBindingUtil.setContentView(this,R.layout.activity_mdpe_tpi_pending);
        sharedPrefs = new SharedPrefs(this);
        Layout_ID();

        rel_nodata =  tpiPendingBinding.relNodata;
        refresh =  tpiPendingBinding.btnTryAgain;
    ...
    public void pendingNetwork_call() {
        ...
        String url = Constants.MDPETPIPENDING+sharedPrefs.getZone_Code();
        Log.d(log,url);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("200")) {
                                ...
                                for(int i=0; i<data_array.length();i++) {
                                    ...
                                    subAllocation.setUserName(data_object.getString("agent_name"));
                                    subAllocation.setUserMob(data_object.getString("agent_mob"));
                        ...
                        mdpeList_adapter = new MdpeTPI_Adapter(MdpeTpiPending.this,suballo);
