package com.fieldmobility.igl.circularprogressbar;
...
public class CircleProgressBar extends ProgressBar {
    ...
    private static final String COLOR_BLUE = "#ff1595f6";
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressStartColor = a.getColor(R.styleable.CircleProgressBar_progress_start_color, Color.parseColor(COLOR_BLUE));
        mProgressEndColor = a.getColor(R.styleable.CircleProgressBar_progress_end_color, Color.parseColor(COLOR_BLUE));
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_progress_text_color, Color.parseColor(COLOR_BLUE));
