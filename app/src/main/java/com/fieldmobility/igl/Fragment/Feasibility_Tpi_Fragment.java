...
public class Feasibility_Tpi_Fragment extends Activity {

    ProgressDialog progressDialog;
    SharedPrefs sharedPrefs;
    ImageView back,new_regestration;
    MaterialDialog materialDialog;
    private ArrayList<Bp_No_Item> bp_no_array;
    ...
    Context context;
    public Feasibility_Tpi_Fragment() {
        // Required empty public constructor
    }
    public Feasibility_Tpi_Fragment(Activity activity) {
  ...
  /*  @Override
    public void onContactSelected(Bp_No_Item contact) {
        Toast.makeText(Feasibility_Tpi_Fragment.this, "Selected: " + contact.getBp_number() + ", " + contact.getFirst_name(), Toast.LENGTH_LONG).show();
