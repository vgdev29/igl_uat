...
public class Ready_Inspection_Tpi_Fragment extends Activity implements RFC_Approval_Adapter.ContactsAdapterListener{
    ...
    TextView list_count;
    public Ready_Inspection_Tpi_Fragment() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.RFC_LISTING_TPI_GET+sharedPrefs.getZone_Code()+"?id="+sharedPrefs.getUUID(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new RFC_Approval_Adapter(Ready_Inspection_Tpi_Fragment.this,bp_no_array,Ready_Inspection_Tpi_Fragment.this);
    ...
    public void onContactSelected(Bp_No_Item contact) {
        Toast.makeText(Ready_Inspection_Tpi_Fragment.this, "Selected: " + contact.getBp_number() + ", " + contact.getFirst_name(), Toast.LENGTH_LONG).show();
