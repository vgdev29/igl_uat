...
import com.fieldmobility.igl.Adapter.NgDoneListAdapter;
...
public class Ng_Done_Fragment extends Activity {
    ...
    private NgDoneListAdapter adapter;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                try {
                    ...
                    if(Utils.isNetworkConnected(Ng_Done_Fragment.this)){
                        loadNgUserList();
                    }else {
                        Utils.showToast(Ng_Done_Fragment.this,"Please check your connectivity");
    ...
    private void loadNgUserList() {
        ...
        Call<ArrayList<NguserListModel>> call = api.getNgPendingList("DN");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (claimUserList.size()>0) {
                    ...
                    adapter = new NgDoneListAdapter(Ng_Done_Fragment.this, claimUserList);
