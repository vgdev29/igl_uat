...
public class MitdOther extends AppCompatActivity {
    ...
    TextView list_count;
    static String log = "mitdotherlisting";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mitd_other);
    ...
    public void Bp_No_List() {
        materialDialog = new MaterialDialog.Builder(this)
                ...
                .progress(true, 0)
                .show();
        String url = Constants.MITD_OTHER_LISTING_GET+sharedPrefs.getUUID();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        adapter = new MITDRFC_Adapter(MitdOther.this,bp_no_array);
