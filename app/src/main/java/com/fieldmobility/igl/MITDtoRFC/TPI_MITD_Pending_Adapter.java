...
public class TPI_MITD_Pending_Adapter extends RecyclerView.Adapter<TPI_MITD_Pending_Adapter.ViewHolder> implements Filterable {
    Context context;
    ...
    public TPI_MITD_Pending_Adapter(Context context, ArrayList<BpDetail> New_bp_no_list_array) {
    ...
    @Override
    public TPI_MITD_Pending_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.rfc_pending_layout, parent, false);
        sharedPrefs = new SharedPrefs(context);
        TPI_MITD_Pending_Adapter.ViewHolder viewHolder = new TPI_MITD_Pending_Adapter.ViewHolder(listItem);
    ...
    @Override
    public void onBindViewHolder(final TPI_MITD_Pending_Adapter.ViewHolder holder, int position) {
        ...
        //logic for status
        if (Bp_No_array.getIglStatus().equals("13")) {
        ...
        if (Bp_No_array.getRfcTpi()==null || Bp_No_array.getRfcTpi().equalsIgnoreCase("null") )
        {
        ...
        else if(Bp_No_array.getRfcTpi().equalsIgnoreCase(sharedPrefs.getUUID())) {
        ...
        else
        {
            ...
            holder.claimed_button.setVisibility(View.GONE);
            holder.job_start_button.setVisibility(View.GONE);
            holder.status_text.setText("BP Claimed by other TPI");
        }
    ...
    public void Claimed_API_POST(BpDetail Bp_No_array , int position) {
        materialDialog = new MaterialDialog.Builder(context)
                ...
                .progress(true, 0)
                .show();
        String url = Constants.MITDClaimUnclaim + BP_N0 + "?flag=" + Claim_Flage + "&id=" + sharedPrefs.getUUID();
        Log.d(log, "url = " + url);
        String login_request = "login_request";
        StringRequest jr = new StringRequest(Request.Method.POST, Constants.MITDClaimUnclaim + BP_N0,
